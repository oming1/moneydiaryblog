...
- **전기차 제조업체**: Rivian(US, [RIVN](/company-analysis/rivn/)), Lucid Group(US, [LCID](/company-analysis/lcid/))
    
- **상용차 제조업체**: Daimler Truck(DE, DTG), Volvo Group(SE, VOLV-B)

## 후방산업

- **반도체 제조업체**: NVIDIA(US, [NVDA](/company-analysis/nvda/)), Infineon Technologies(DE, [IFX](/company-analysis/ifx/))
    
- **배터리 공급업체**: LG Energy Solution(KR), CATL(CN)
    
- **소재 공급업체**: BASF(DE, BAS), DuPont(US, [DD](/company-analysis/dd/))
...
1. 자동차 제조사 (Tesla(US, [TSLA](/company-analysis/tsla/)), General Motors(US, [GM](/company-analysis/gm/)))
    
2. 상용차 제조사 (Daimler Truck(DE, DTG), Volvo Group(SE))
    
3. 전기차 스타트업 (Rivian(US, [RIVN](/company-analysis/rivn/)), Lucid Group(US))
