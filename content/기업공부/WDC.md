...
- 제조 장비: Applied Materials(US, [AMAT](/company-analysis/amat/))

## 밸류체인

1. 설계 및 개발: Western Digital(US, [WDC](/company-analysis/wdc/)) (HDD 및 SSD 설계)
2. 원자재 공급: Sumitomo Chemical(JP, 4005) (반도체 소재)
3. 제조 및 조립: Western Digital(US, [WDC](/company-analysis/wdc/)) (HDD 및 SSD 생산)
...
- [데이터센터](/industry-study/데이터센터/) 솔루션: Zoned Storage 기반 시스템 및 OpenFlex 플랫폼, 매출의 약 20% (2024년 기준)

## 주요 고객

- Amazon Web Services(US, [AMZN](/company-analysis/amzn/)) - 클라우드 스토리지
- Dell Technologies(US, [DELL](/company-analysis/dell/)) - 엔터프라이즈 스토리지 솔루션
...
- Seagate Technology(US, [STX](/company-analysis/stx/)) - HDD 및 데이터 스토리지 솔루션
- Samsung Electronics(KR, 005930) - SSD 및 메모리 제품
- Micron Technology(US, [MU](/company-analysis/mu/)) - 메모리 및 스토리지 솔루션
