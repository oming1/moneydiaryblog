...
**영위사업**: Riot Platforms는 [비트코인](/company-analysis/비트코인/) 채굴 및 디지털 인프라를 전문으로 하는 회사입니다. 이 회사는 북미에서 가장 큰 비트코인 채굴 시설을 운영하며, 텍사스와 켄터키에 데이터 센터를 두고 있습니다. 또한, 덴버에서 전기 스위치기어 엔지니어링 및 제작 작업을 수행합니다
...
- **[데이터센터](/industry-study/데이터센터/) 운영**: 데이터 센터를 소유하고 운영하며, 비트코인 채굴을 위한 인프라 제공
    - **대표 회사**: Core Scientific (미국, [CORZ](/company-analysis/corz/)), Bitfarms (캐나다, BITF)
