---
title: "MELI"
date: 2025-07-10T11:26:01+09:00
lastmod: 2025-10-15T09:15:01+09:00
type: docs
sidebar:
  open: false
weight: 561
...
<div style="display:none">
  <meta property="article:published_time" content="2025-07-10T02:26:01Z" />
  <meta property="article:modified_time" content="2025-10-15T00:15:01Z" />
</div>
...
[AI 기반 신용 평가] 및 [위험 관리 기술], [개인화 추천 알고리즘], [물류 최적화 시스템], 모바일 결제 기술, 블록체인 기술, 데이터 분석 및 머신러닝, [클라우드](/industry-study/2산업클라우드/) 인프라 기술, [사이버 보안](/industry-study/사이버-보안/) 기술, 디지털 지갑 기술, 암호화폐 거래 기술
...
- IT 인프라 제공업체: AWS(US, [AMZN](/company-analysis/amzn/)), Microsoft Azure(US, [MSFT](/company-analysis/msft/))
- 물류 서비스업체: DHL(DE, [DHL](/company-analysis/dhl/)), FedEx(US, [FDX](/company-analysis/fdx/))
- 결제 처리업체: Visa(US, [V](/company-analysis/v/)), Mastercard(US, [MA](/company-analysis/ma/))
- 클라우드 서비스업체: Google Cloud(US, [GOOGL](/company-analysis/googl/)), Oracle(US, [ORCL](/company-analysis/orcl/))
...
- Microsoft(US, [MSFT](/company-analysis/msft/)) - 소프트웨어 및 클라우드 서비스
- Google(US, [GOOGL](/company-analysis/googl/)) - 클라우드 및 AI 기술
- Oracle(US, [ORCL](/company-analysis/orcl/)) - 데이터베이스 관리 시스템
- Salesforce(US, [CRM](/company-analysis/crm/)) - CRM 솔루션

**결제 처리 단계:** 결제 인프라 및 금융 서비스

- Visa(US, [V](/company-analysis/v/)) - 결제 네트워크 서비스
- Mastercard(US, [MA](/company-analysis/ma/)) - 글로벌 결제 처리
- PayPal(US, [PYPL](/company-analysis/pypl/)) - 디지털 결제 기술
- Fiserv(US, FI) - 금융 기술 솔루션

**물류 및 배송 단계:** 물류 네트워크 및 배송 서비스

- FedEx(US, [FDX](/company-analysis/fdx/)) - 국제 배송 서비스
- UPS(US, [UPS](/company-analysis/ups/)) - 물류 및 배송 서비스
- DHL(DE, [DHL](/company-analysis/dhl/)) - 국제 특송 서비스
- 현지 물류 파트너사들 - 라틴 아메리카 지역 배송

**고객 서비스 단계:** 고객 지원 및 서비스 제공

- Zendesk(US, ZEN) - 고객 서비스 플랫폼
- Twilio(US, [TWLO](/company-analysis/twlo/)) - 통신 API 서비스
- Qualtrics(US, QLTC) - 고객 경험 관리

---

## 주요제품

**MercadoLibre 마켓플레이스:** 온라인 쇼핑 플랫폼, 매출 비중 약 45% (2024년 기준), 관련 경쟁사 [AMZN](/company-analysis/amzn/), [BABA](/company-analysis/baba/)

**Mercado Pago:** 디지털 결제 서비스, 매출 비중 약 41% (2024년 기준), 관련 경쟁사 [PYPL](/company-analysis/pypl/), [SQ](/company-analysis/sq/)
...
- 주요 공급 지역: 대만, 한국, 중국
- 주요 공급 업체: Taiwan Semiconductor [TSM](/company-analysis/tsm/), Samsung 005930.KS
...
- Amazon(US, [AMZN](/company-analysis/amzn/)) - 글로벌 이커머스 플랫폼, 라틴 아메리카 진출 확대
- Nubank(BR, [NU](/company-analysis/nu/)) - 브라질 디지털 뱅킹, 핀테크 서비스 경쟁
- Shopee(SG, [SE](/company-analysis/se/)) - 동남아시아 이커머스, 라틴 아메리카 진출
- PayPal(US, [PYPL](/company-analysis/pypl/)) - 글로벌 디지털 결제 서비스
- Block(US, [SQ](/company-analysis/sq/)) - 디지털 결제 및 핀테크 서비스
- Alibaba(CN, [BABA](/company-analysis/baba/)) - 글로벌 이커머스 및 AliExpress 서비스
- PagSeguro(BR, PAGS) - 브라질 디지털 결제 서비스
- Stone(BR, STNE) - 브라질 결제 처리 서비스
- Uala(AR, Uala) - 아르헨티나 핀테크 서비스
- Rappi(CO, Rappi) - 라틴 아메리카 딜리버리 플랫폼
- Magazine Luiza(BR, MGLU3.SA) - 브라질 온라인 리테일
- Via(BR, VIIA3.SA) - 브라질 이커머스 플랫폼
- Linio(MX, Linio) - 멕시코 온라인 마켓플레이스
- Cornershop(CL, Cornershop) - 라틴 아메리카 식료품 배송
- iFood(BR, iFood) - 브라질 음식 배송 서비스
...
- VanEck Vectors Emerging Markets ETF - VWO
