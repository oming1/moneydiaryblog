...
- 태양광 발전: 유틸리티 규모 태양광 프로젝트 (NextEra Energy(US, [NEE](/company-analysis/nee/)), Duke Energy(US, [DUK](/company-analysis/duk/)))
    
- 에너지 저장: 배터리 저장 시스템 (Tesla(US, [TSLA](/company-analysis/tsla/)), LG Energy Solution(KR, 373220))
...
2. SolarEdge Technologies(US, [SEDG](/company-analysis/sedg/)): 태양광 인버터 및 전력 최적화
    
3. Enphase Energy(US, [ENPH](/company-analysis/enph/)): 마이크로인버터 시스템
