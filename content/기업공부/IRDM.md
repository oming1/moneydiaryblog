...
## 영위 사업
Iridium Communications Inc.는 미국의 위성 통신 회사로, 전 세계적으로 음성 및 데이터 통신 서비스를 제공하는 Iridium 위성 군을 운영합니다. 이 회사는 66개의 활성 위성과 9개의 예비 위성([저궤도 위성](/industry-study/저궤도-위성/), 소형 위성, [통신 위성](/industry-study/통신-위성/))을 통해 고객에게 글로벌 서비스를 제공합니다. Iridium의 통신 시스템은 휴대용 위성 전화, 위성 메신저 장치 및 통합 트랜시버를 통해 사용됩니다.
...
- **전방 산업 (Downstream Industry)**:
    ...
    - **주요 기업**:
        ...
        - Inmarsat (영국, ISAT) - 위성 통신 서비스 제공
        - Globalstar (미국, [GSAT](/company-analysis/gsat/)) - 위성 기반 통신 서비스 제공
...
- **Inmarsat (영국, ISAT)**: 다양한 위성 통신 서비스 제공.
- **Globalstar (미국, [GSAT](/company-analysis/gsat/))**: 저비용 위성 기반 통신 서비스 제공.
